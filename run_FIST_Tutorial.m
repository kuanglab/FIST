...
data_path = 'FIST_data/FIST_tutorial_output/';
utils_path = 'FIST_data/FIST_utils';
data_name = 'V1_Human_Heart';
PPI_name = 'HSA_PPI.mat'; %use HSA_PPI.mat for human data and MUS_PPI.mat for mouse data
